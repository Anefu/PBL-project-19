...
# Create the certificate using a wildcard for all the domains created in testprj10.tk
resource "aws_acm_certificate" "project_19_cert" {
  domain_name       = "*.testprj10.tk"
